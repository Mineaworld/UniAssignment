              ...
              {filtered.map(assignment => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex flex-col justify-between bg-white dark:bg-[#101622]/50 border border-gray-200 dark:border-white/10 rounded-xl p-6 hover:shadow-xl dark:hover:shadow-primary/5 transition-all duration-300 group relative"
                  >
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100 dark:border-white/5 flex items-center justify-end gap-3">
                      {!isCompleted ? (
                         <button 
                            onClick={() => updateAssignment(assignment.id, { status: Status.Completed })}
                        ...
                        <button 
                           onClick={() => updateAssignment(assignment.id, { status: Status.InProgress })}
                           className="px-4 py-2 bg-green-600/10 text-green-600 dark:text-green-400 text-sm font-bold rounded-lg cursor-default"
                        >
                           Completed
                        </button>
                      )}
