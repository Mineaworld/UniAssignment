...
const assignmentToFormData = (assignment: Assignment): FormData => ({
    ...
    date: extractDatePart(assignment.dueDate),
    time: extractTimePart(assignment.dueDate),
...
const EditAssignmentModal: React.FC<EditAssignmentModalProps> = ({ isOpen, onClose, assignment }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size="lg" className="max-h-[90vh] overflow-y-auto">
            <>
                {/* Header */}
